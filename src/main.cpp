...
char topic1[]= "status4";   
char topic2[]= "reset4";        // topico MQTT
char topic3[]= "memoria4";  
char topic4[]= "tempideal4";
char topic5[]= "permissao4";
char topic6[]= "permissaoResposta4";
...
void callback(char* topicc, byte* payload, unsigned int length){
  ...
  if(topicStr=="memoria4"){ 
    ...
    topicStr="";
  }else if(topicStr="permissaoResposta4"){
...
//mac 3 biitF872FDBF713C redação CK
